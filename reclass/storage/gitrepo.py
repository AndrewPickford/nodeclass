...
class GitRepo:
    ...
    def __init__(self, repo, cache_dir=None, lock_file=None, pubkey=None, privkey=None, password=None):
        ...
        self.cache_dir = cache_dir or '{0}/{1}/{2}'.format(os.path.expanduser("~"), '.reclass/cache/git', self.id)
        self.lock_file = lock_file or '{0}/{1}/{2}'.format(os.path.expanduser("~"), '.reclass/cache/lock', self.id)
